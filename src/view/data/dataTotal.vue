        ...
        <el-col :span="6">
             <el-card :body-style="{ padding: '0px' }" shadow="always">
               ...
               <div class="today2">
                   ...
                   <div class="todayText2s">注册率：<span style="color:#000;font-size:18px">{{this.todayRegisteRate*100}}%</span></div>
                </div>
                <div class="divider"></div>
               ...
               <div class="today2" style="margin-bottom: 20px">
                   ...
                   <div class="todayText2s">注册率：<span style="color:#000;font-size:18px">{{this.totalRegisteRate*100}}%</span></div>
                </div>
            </el-card>
        </el-col>
        <el-col :span="6">
             <el-card :body-style="{ padding: '0px' }" shadow="always">
               ...
               <div class="today2">
                   ...
                   <div class="todayText2s">付款率：<span style="color:#000;font-size:18px">{{this.todayPayRate*100}}%</span></div>
                </div>
                <div class="divider"></div>
               ...
               <div class="today2" style="margin-bottom: 20px">
                   ...
                   <div class="todayText2s">付款率：<span style="color:#000;font-size:18px">{{this.totalPayRate*100}}%</span></div>
                </div>
            </el-card>
        </el-col>
        <el-col :span="6">
              <el-card :body-style="{ padding: '0px' }" shadow="always">
               ...
               <div class="today2">
                   ...
                   <div class="todayText2s">认证率：<span style="color:#000;font-size:18px">{{this.todayFaceRate*100}}%</span></div>
                </div>
                <div class="divider"></div>
               ...
               <div class="today2" style="margin-bottom: 20px">
                   ...
                   <div class="todayText2s">认证率：<span style="color:#000;font-size:18px">{{this.totalFaceRate*100}}%</span></div>
                </div>
            </el-card>
        </el-col>
        <el-col :span="6">
             <el-card :body-style="{ padding: '0px' }" shadow="always">
               ...
               <div class="today2">
                   ...
                   <div class="todayText2s">绑卡率：<span style="color:#000;font-size:18px">{{this.todayBankRate*100}}%</span></div>
                </div>
                <div class="divider"></div>
                 <div class="today1"><div class="todays1"></div><div class="todayText">累积</div></div>
               <div class="today2" style="margin-bottom: 20px">
                   <div class="today2s">绑卡人数：<span style="color:#000;font-size:18px">{{this.totalBankCount}}</span></div>
                   <div class="todayText2s">绑卡率：<span style="color:#000;font-size:18px">{{this.totalBankRate*100}}%</span></div>
                </div>
            </el-card>
        </el-col>
        </el-row>
	...
	methods: {
        ...
        qryBusinessStatistics({source: this.source}).then(res => {
          if(res.data.code == 200){
            ...
            this.todayRegisteRate = res.data.data.todayRegisteRate;
            this.totalRegisteRate = res.data.data.totalRegisteRate;
            this.todayPayRate = res.data.data.todayPayRate;
            this.totalPayRate = res.data.data.totalPayRate;
            ...
            this.todayFaceRate = res.data.data.todayFaceRate;
            this.todayBankRate = res.data.data.todayBankRate;
            this.totalFaceRate = res.data.data.totalFaceRate;
            this.totalBankRate = res.data.data.totalBankRate;
