...
<template>
  <div id="app" style="margin: 20px">
        ...
        <div v-if="this.width <=600" class="sSearch">
           <div>
      ...
      <Row v-else-if="this.width > 600"  style=" margin-left: -40px">
...
import {qryMyChannelListTwo,qryMySourceAll,qrySourceAll} from '../../api/qudao.js';
  export default {
    data () {
      return {
        width: '',
    ...
    methods:{
      ...
      qrySource() {
        ...
        this.loading = true;
        if(!this.createTime) {
          qryMyChannelListTwo({pageSize: this.pageSize,pageNum: this.currentPage,source_cnd: this.source_cnd,
