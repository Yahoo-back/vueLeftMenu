...
<template>
  ...
  <el-breadcrumb-item>渠道注册</el-breadcrumb-item>
</el-breadcrumb>
      ...
      <!-- <Row  style=" margin-left: -40px">
         <div class="demo-input-suffix">
          <div class="search">
            <el-input placeholder="请输入字符" style="width: 180px" v-model="code" suffix-icon="el-icon-search" clearable />
          </div>
          <div class="search" style="margin-top: 20px">
            <el-button  @click="handleEncrypt()" type="primary" size="small" style="margin-left: 20px">加密</el-button><span style="margin-left: 20px">加密字段：{{this.encrypt}}</span>
             <el-button @click="handleDecrypt()" type="primary" size="small" style="margin-left: 20px">解密</el-button><span style="margin-left: 20px">解密字段：{{this.decrypt}}</span>
          </div>
...
import * as table from './data/table';
  export default {
    ...
    methods:{
      ...
      handleEncrypt(){
        // md5加密
        var jiami = this.$md5(this.code)
        this.encrypt = jiami
        // base64加密
        // var jiamiBase = Base64.encode(this.code) 
        // this.encrypt = jiamiBase
      },
      // 解密
      handleDecrypt(){
        // base64解密
        // let Base64 = require('js-base64').Base64;
        // var jiemi = Base64.decode(this.encrypt)
        // this.decrypt = jiemi
